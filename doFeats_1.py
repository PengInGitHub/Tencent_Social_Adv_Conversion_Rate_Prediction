...
rawpath='/Users/pengchengliu/Downloads/final/'
temppath='/Users/pengchengliu/Downloads/final/temp/'
iapath='/Users/pengchengliu/Downloads/final/installedactions'

#define custom logloss
#http://algo.tpai.qq.com/home/information/index.html
#definition and interpretation of logloss: http://www.exegetic.biz/blog/2015/12/making-sense-logarithmic-loss/
...
def readData(m_type='inner',drop=True):  ###################使用Trick时，left merge不改变顺序会比inner merge差1个万分点左右？
    ...
    if drop:
        ...
        #drop a column:        data.drop('column_to_drop', axis=1, inplace=True)
    ...
    del userfile
    gc.collect()#force the Garbage Collector to release unreferenced memory with gc.collect()
...
#X_loc_train: (37,913k,22)
#X_loc_test:  ( 3,322k,23)
print('readData over')
X_loc_train=doPre(X_loc_train)
X_loc_test=doPre(X_loc_test)#day and hour added
print('doPre over...')
